    ...
    <FormWrapper>
      <FormEl>
        <FormContent>
          ...
          <FormGroup>
        <Radio label="Resources For" options={['Clinicans', 'Everyone']} selectedOptions={['Clinicians']} />
        <Radio label="Area" options={['Behavioral Health Services', 'Coping']} selectedOptions={[]} onOptionToggle={onOptionToggle} />
      </FormGroup>
        </FormContent>
        <FormFooter>
