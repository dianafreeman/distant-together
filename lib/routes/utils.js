    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            json = _ref.json, _ref$targetPath = _ref.targetPath, targetPath = _ref$targetPath === void 0 ? "server/data" : _ref$targetPath, successMessage = _ref.successMessage;
...
var createUniqueSet = function createUniqueSet(data, key) {
  ...
  return (0, _toConsumableArray2.default)(new Set(unique));
};
